...
$( function(){
	$('.game_container').click(function(){
		...
		$('.game_play').css('display','block');
		$('body').css({'height':'100%','overflow':'hidden','background':'#000','opacity':'0.9'});
		//$('.logo').css('display','none');
		$('.games_con_3').css('display','none');
		$('.games_con_4').css('display','none');
		$('.box-sidebar').css('display','block');
		$('.g_botcom').css('display','block');
	})
	$('.box-sidebar').click(function(){
		exitFullscreen();
		$('.game_mask').css('display','block');
		$('.game_play').css('display','none');
		$('body').css({'height':'auto','overflow':'auto'});
		$('.logo').css('display','block');
		$('.box-sidebar').css('display','none');
		$('.g_botcom').css('display','none');
	})
})
